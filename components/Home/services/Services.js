...
function CustomTabPanel(props) {
  const { children, value, index, servicesList, handleChange, ...other } =
    props;
                ...
                <Tab
                  ...
                  label={
                    <Box
                      ...
                      justifyContent={"space-around"}
                      position={"relative"}
                      color={value === i ? service?.color : "gray"}
                    >
                      {/* SVG as background */}
                      <Box
                        Box
...
function Services() {
  const servicesList = [
    {
      icon: <ConstructionIcon sx={{ fontSize: "40px" }} />,
      title: "Assembly",
      bgColor: "rgba(146, 236, 161, 0.5)",
      color: "rgba(34, 63, 40, 0.5)",
    },
    {
      icon: <BuildIcon sx={{ fontSize: "40px" }} />,
      title: "Mounting",
      bgColor: "rgba(224, 103, 178, 0.5)",
      color: "rgba(193, 58, 141, 0.5)",
    },
    {
      icon: <LocalShippingIcon sx={{ fontSize: "40px" }} />,
      title: "Moving",
      bgColor: "rgba(255, 204, 0, 0.5)",
      color: "rgba(137, 88, 15, 0.5)",
    },
    {
      icon: <CleaningServicesIcon sx={{ fontSize: "40px" }} />,
      title: "Cleaning",
      bgColor: "rgba(0, 204, 255, 0.5)",
      color: "rgba(14, 60, 106, 0.5)",
    },
    {
      icon: <ConstructionIcon sx={{ fontSize: "40px" }} />,
      title: "Outdoor Help",
      bgColor: "rgba(0, 255, 127, 0.5)",
      color: "rgba(0, 127, 63, 0.5)",
    },
    {
      icon: <HomeIcon sx={{ fontSize: "40px" }} />,
      title: "Home Repairs",
      bgColor: "rgba(255, 0, 127, 0.5)",
      color: "rgba(127, 0, 63, 0.5)",
    },
    {
      icon: <FormatPaintIcon sx={{ fontSize: "40px" }} />,
      title: "Painting",
      bgColor: "rgba(127, 0, 255, 0.5)",
      color: "rgba(70, 15, 126, 0.5)",
    },
    {
      icon: <WhatshotIcon sx={{ fontSize: "40px" }} />,
      title: "Trending",
      bgColor: "rgba(255, 127, 0, 0.5)",
      color: "rgba(127, 63, 0, 0.5)",
    },
  ];
